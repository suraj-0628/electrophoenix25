...
const Header = () => {
  return (
    <div className='bg-black text-white flex justify-center items-center h-20 fixed  w-[100vw] ' >
        ...
        <img className='' src="/src/assets/hamburger-icon.jpg" alt="hamburger-icon" height={25} width={25} />
        </div>
         <img src="/src/assets/electrophoenix_logo.jpg" alt="logo" height={50} width={50}/>
